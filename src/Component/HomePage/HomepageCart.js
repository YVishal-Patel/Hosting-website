...
function HomepageCart(props) {
  return (
      <>
      <hr />
      <div className="homePageCart">
          <div className="cart">
           ...
           <div className="visit-site-icon">
               <p>Visit site </p>
               <span> <svg xmlns="http://www.w3.org/2000/svg" class="site-icons" viewBox="0 0 20 20" fill="currentColor">
